...
const publish = async (folder: string, connection: any, provider: string, dryRun: boolean) => {
    ...
    assetBuilder.setType('dataset')
        ...
        .setNftData({
            ...
            symbol: 'TFD',
            templateIndex: 1,
            tokenURI: 'https://www.veeqo.com/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fhfb264dqso7g%2F4QovdfnQYcBgP0X4PN0QfM%2F6313238ef1c4def0614eb43b209bbf5b%2Fdemand-forecasting.jpg&w=2560&q=75',
            transferable: false
        })
        .addLinks(['https://www.kaggle.com/api/v1/datasets/download/sudipmanchare/simulated-sales-data-with-timeseries-features'])
