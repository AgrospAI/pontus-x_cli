...
export default class GenerateParticipantCredentials extends Command {
  static description = 'Generate the Gaia-X credentials for the participant including their verifiable presentation'
  ...
  async run(): Promise<void> {
    ...
    try {
      ...
      await generateCredentials(flags.participant, flags.didjson, flags.certificate, password)
    } catch (error) {
